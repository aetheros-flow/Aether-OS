      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-0 bottom-0 z-50 max-h-[82vh] rounded-t-[28px] bg-[#241E1A] border-t border-[rgba(232,221,204,0.08)] flex flex-col pb-[calc(env(safe-area-inset-bottom,0px)+8px)] touch-pan-y"
          >
