        ...
        <>
          ...
          >
            ...
            <div className="px-5 pb-3 flex items-center justify-between shrink-0">
              <h3 className="font-serif text-xl text-white tracking-tight">Agregar Video</h3>
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto custom-scrollbar px-5 pb-8 pt-2 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-black tracking-[0.22em] uppercase text-zinc-500">URL del video</label>
                ...
                {platform && platform !== 'other' && (
                  <div className="flex items-center gap-1.5 text-[11px]">
                    ...
                    />
                    <span className="text-zinc-400">Detectado:</span>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-black tracking-[0.22em] uppercase text-zinc-500">Título (opcional)</label>
                <input
                  type="text"
                  value={title}
                  onChange={e => setTitle(e.target.value)}
                  placeholder="Dejalo vacío para usar el título de la plataforma"
              ...
              {/* List picker */}
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-black tracking-[0.22em] uppercase text-zinc-500">Lista</label>
                <div className="flex gap-2 overflow-x-auto hide-scrollbar scroll-smooth -mx-5 px-5 pb-1">
                  <ListChip label="Sin lista" active={listId === null} onClick={() => setListId(null)} />
              ...
              {/* Description */}
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-black tracking-[0.22em] uppercase text-zinc-500">Nota (opcional)</label>
                <textarea
                  value={description}
                  onChange={e => setDescription(e.target.value)}
                  placeholder="¿Por qué lo guardás?"
                  rows={3}
